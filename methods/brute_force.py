...
Genera todas las combinaciones posibles en orden creciente
Compatible con validadores (WPA/WPA2) o comparación simple
"""
import itertools
import config
...
class BruteForcAttack(AttackMethod):
    """Método de fuerza bruta puro - prueba todas las combinaciones"""

    def __init__(self, validator=None, min_length=None, max_length=None, charset=None):
        """
        Inicializa el método de fuerza bruta
        
        Args:
            validator: Objeto validador (WPAValidator, función, etc)
        ...
        """
        super().__init__("brute-force", validator=validator)
